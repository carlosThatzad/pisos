...
<div class="main-container">
    ...
    <header class="block">
        <ul class="header-menu horizontal-list">
            <li>
                <a class="header-menu-tab" href="#1"><span class="icon entypo-cog scnd-font-color"></span>Crear Producto</a>
            </li>
            <li>
    ...
    <div class="left-container container">
        <div class="menu-box block"> <!-- MENU BOX (LEFT-CONTAINER) -->
            <h2 class="titular">CLIENTE PANEL</h2>
            <ul class="menu-box-menu">
                ...
                <li>
                    <a class="menu-box-tab" href="listproducts.tpl.php"><span class="icon entypo-calendar scnd-font-color"></span>Listar <div class="menu-box-number">5</div></a>
                </li>
                <li>
